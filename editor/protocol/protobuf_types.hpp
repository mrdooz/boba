...
namespace editor { namespace protobuf { 
  ...
  struct DescriptorProto
  {
    ...
    vector<EnumDescriptorProto> enumType;
    vector<::editor::protobuf::DescriptorProto::ExtensionRange> extensionRange;
  ...
  struct UninterpretedOption
  {
    ...
    vector<::editor::protobuf::UninterpretedOption::NamePart> name;
  ...
  struct SourceCodeInfo
  {
    ...
    vector<::editor::protobuf::SourceCodeInfo::Location> location;
  };
