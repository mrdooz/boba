...
enum EffectSetting_Type {
  ...
  EffectSetting_Type_Particle = 2,
  EffectSetting_Type_Generator = 3
};
bool EffectSetting_Type_IsValid(int value);
const EffectSetting_Type EffectSetting_Type_Type_MIN = EffectSetting_Type_Unknown;
const EffectSetting_Type EffectSetting_Type_Type_MAX = EffectSetting_Type_Generator;
...
class EffectSetting : public ::google::protobuf::Message {
 public:
  ...
  static const Type Particle = EffectSetting_Type_Particle;
  static const Type Generator = EffectSetting_Type_Generator;
