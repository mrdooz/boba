...
_FLOATKEYFRAME.fields_by_name['key'].message_type = _VECTOR2
_FLOATKEYFRAME.fields_by_name['cp_in'].message_type = _VECTOR2
_FLOATKEYFRAME.fields_by_name['cp_out'].message_type = _VECTOR2
